...
/* Array structures for reference
    {"articles":[{"id":1,"title":"asdasdas","url":"asdasdasas","username":"s","commentIds":[],"upvotedBy":[],"downvotedBy":[],"comments":[]}]}
    
    {"comment":{"id":1,"body":"asdasdasd","username":"s","articleId":1,"upvotedBy":[],"downvotedBy":[]}}
    
    {"user":{"username":"s","articleIds":[1],"commentIds":[1]},"userArticles":[{"id":1,"title":"asdasdas","url":"asdasdasas","username":"s","commentIds":[],"upvotedBy":[],"downvotedBy":[],"comments":[]}],"userComments":[{"id":1,"body":"asdasdasd","username":"s","articleId":1,"upvotedBy":[],"downvotedBy":[]}]}
 */

const yaml = require('js-yaml');
const fs   = require('fs');
const yml = require('write-yaml');

/*uncomment for live database*/
//let database = yaml.load(fs.readFileSync("thescoop.yml"));
...
function loadDatabase(){
    try {
        yaml.safeLoad(fs.readFileSync('thescoop.yml'));
    }catch (e){
        console.log(e);
    }
}
...
function saveDatabase(){
     yml('thescoop.yml', database, function(err) {
        console.log(err); 
     });
}
